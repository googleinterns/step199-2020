...
public final class SensorData {
  ...
  public static final class Pose extends com.google.protobuf.GeneratedMessageV3
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (gpsTimestamp_ != 0D) {
        size += com.google.protobuf.CodedOutputStream.computeDoubleSize(1, gpsTimestamp_);
      }
      if (lat_ != 0D) {
        size += com.google.protobuf.CodedOutputStream.computeDoubleSize(2, lat_);
      }
      if (lng_ != 0D) {
        size += com.google.protobuf.CodedOutputStream.computeDoubleSize(3, lng_);
      }
      if (alt_ != 0D) {
        size += com.google.protobuf.CodedOutputStream.computeDoubleSize(4, alt_);
      }
      if (rollDeg_ != 0F) {
        size += com.google.protobuf.CodedOutputStream.computeFloatSize(5, rollDeg_);
      }
      if (pitchDeg_ != 0F) {
        size += com.google.protobuf.CodedOutputStream.computeFloatSize(6, pitchDeg_);
      }
      if (yawDeg_ != 0F) {
        size += com.google.protobuf.CodedOutputStream.computeFloatSize(7, yawDeg_);
      }
      memoizedSize = size;
      return size;
    }
      ...
      result =
          result
              && (java.lang.Double.doubleToLongBits(getGpsTimestamp())
                  == java.lang.Double.doubleToLongBits(other.getGpsTimestamp()));
      result =
          result
              && (java.lang.Double.doubleToLongBits(getLat())
                  == java.lang.Double.doubleToLongBits(other.getLat()));
      result =
          result
              && (java.lang.Double.doubleToLongBits(getLng())
                  == java.lang.Double.doubleToLongBits(other.getLng()));
      result =
          result
              && (java.lang.Double.doubleToLongBits(getAlt())
                  == java.lang.Double.doubleToLongBits(other.getAlt()));
      result =
          result
    ...
    public int hashCode() {
      ...
      hash =
          (53 * hash)
              + com.google.protobuf.Internal.hashLong(java.lang.Double.doubleToLongBits(getLat()));
      hash = (37 * hash) + LNG_FIELD_NUMBER;
      hash =
          (53 * hash)
              + com.google.protobuf.Internal.hashLong(java.lang.Double.doubleToLongBits(getLng()));
      hash = (37 * hash) + ALT_FIELD_NUMBER;
      hash =
          (53 * hash)
              + com.google.protobuf.Internal.hashLong(java.lang.Double.doubleToLongBits(getAlt()));
    ...
    public static proto.SensorData.Pose parseFrom(com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static proto.SensorData.Pose parseFrom(com.google.protobuf.CodedInputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3.parseWithIOException(PARSER, input);
    }
  ...
  static {
    ...
    internal_static_formats_Pose_descriptor = getDescriptor().getMessageTypes().get(0);
    internal_static_formats_Pose_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
            internal_static_formats_Pose_descriptor,
            new java.lang.String[] {
              "GpsTimestamp", "Lat", "Lng", "Alt", "RollDeg", "PitchDeg", "YawDeg",
            });
  }
